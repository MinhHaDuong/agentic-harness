...
2. **Log to telemetry**: pipe a JSON summary to `~/.claude/bin/log-celebration`:
   ```bash
   echo '{"project":"<name>","branch":"<branch>","commits":<n>,"files_changed":<n>,"ticket":<number|null>}' | ~/.claude/bin/log-celebration
   ```
